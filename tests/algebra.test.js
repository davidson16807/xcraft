...
function enabledDragOperations() {
    ...
    assert(
        algebra.moves_for_source(zero_equation, 'L', manual_drag_options).length === 0,
        'enabled drag operations: zero should remain ambiguous when add and mul are enabled'
    );
    assert(
