...
This application is a low priority effort. Its creation was taken as an opportunity to experiment with vibe coding. The goal of the experiment was to see whether a application could be vibe coded in a single prompt in such a way that a human maintainer could understand and maintain it. 
...
My other project, [cdcraft](https://davidson16807.github.io/cdcraft/) was chosen as a role model since it I wrote the entirety of the application without the aid of LLM in 2022-2023 while adhering to rigorous design principles that I feel aid in the ability to reason with code. To this day I trust its design and would change little if it had to be reimplemented. cdcraft features the following architectural ideas:
