...
My other project, [cdcraft](https://davidson16807.github.io/cdcraft/) was chosen as a role model since I wrote the entirety of the application back in 2022-2023 without the aid of LLM while adhering to rigorous design principles that I feel aid in the ability to understand and reason with code. To this day, I trust its design and would change little if it had to be reimplemented. cdcraft features the following architectural ideas:
