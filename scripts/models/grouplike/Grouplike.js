...
`Grouplike` manages operations on grouplikes that require knowledge of at least a magma and at most a group,
so `Grouplike` can commute, append, combine, and cancel but not combine, or distribute,
